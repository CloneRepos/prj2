@ST_52197 @tagtagtag @this_is_story_tag
...
@SC_247776 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247777 @third_scenario_tag
...
@SC_247778 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247779 @fifth_scenario_tag
