@ST_77707 @tagtagtag @this_is_story_tag
...
@SC_345643 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345644 @third_scenario_tag
...
@SC_345645 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345646 @fifth_scenario_tag
