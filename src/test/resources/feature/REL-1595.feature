@ST_36904 @tagtagtag @this_is_story_tag
...
@SC_184703 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184704 @third_scenario_tag
...
@SC_184705 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184706 @fifth_scenario_tag
