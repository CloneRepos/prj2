@ST_81534 @tagtagtag @this_is_story_tag
...
@SC_360308 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360309 @third_scenario_tag
...
@SC_360310 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360311 @fifth_scenario_tag
