@ST_107266 @tagtagtag @this_is_story_tag
...
@SC_461004 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461005 @third_scenario_tag
...
@SC_461006 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461007 @fifth_scenario_tag
