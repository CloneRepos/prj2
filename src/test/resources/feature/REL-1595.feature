@ST_110819 @tagtagtag @this_is_story_tag
...
@SC_474558 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474559 @third_scenario_tag
...
@SC_474560 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474561 @fifth_scenario_tag
