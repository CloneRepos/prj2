@ST_79339 @tagtagtag @this_is_story_tag
...
@SC_351811 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351812 @third_scenario_tag
...
@SC_351813 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351814 @fifth_scenario_tag
