@ST_71996 @tagtagtag @this_is_story_tag
...
@SC_323851 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323852 @third_scenario_tag
...
@SC_323853 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323854 @fifth_scenario_tag
