@ST_90037 @tagtagtag @this_is_story_tag
...
@SC_395407 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395408 @third_scenario_tag
...
@SC_395409 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395410 @fifth_scenario_tag
