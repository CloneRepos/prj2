@ST_33566 @tagtagtag @this_is_story_tag
...
@SC_173950 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_173951 @third_scenario_tag
...
@SC_173952 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_173953 @fifth_scenario_tag
