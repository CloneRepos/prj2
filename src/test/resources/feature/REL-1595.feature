@ST_88488 @tagtagtag @this_is_story_tag
...
@SC_389383 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389384 @third_scenario_tag
...
@SC_389385 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389386 @fifth_scenario_tag
