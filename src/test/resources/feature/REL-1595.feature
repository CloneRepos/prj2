@ST_118539 @tagtagtag @this_is_story_tag
...
@SC_504978 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_504979 @third_scenario_tag
...
@SC_504980 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_504981 @fifth_scenario_tag
