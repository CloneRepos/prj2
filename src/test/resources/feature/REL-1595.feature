@ST_35623 @tagtagtag @this_is_story_tag
...
@SC_180914 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180915 @third_scenario_tag
...
@SC_180916 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180917 @fifth_scenario_tag
