@ST_67028 @tagtagtag @this_is_story_tag
...
@SC_304080 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304081 @third_scenario_tag
...
@SC_304082 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304083 @fifth_scenario_tag
