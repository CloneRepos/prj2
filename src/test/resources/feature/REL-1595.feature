@ST_56602 @tagtagtag @this_is_story_tag
...
@SC_264476 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264477 @third_scenario_tag
...
@SC_264478 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264479 @fifth_scenario_tag
