@ST_41072 @tagtagtag @this_is_story_tag
...
@SC_201927 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201928 @third_scenario_tag
...
@SC_201929 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201930 @fifth_scenario_tag
