@ST_119580 @tagtagtag @this_is_story_tag
...
@SC_509075 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509076 @third_scenario_tag
...
@SC_509077 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509078 @fifth_scenario_tag
