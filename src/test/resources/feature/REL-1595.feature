@ST_80030 @tagtagtag @this_is_story_tag
...
@SC_354585 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354586 @third_scenario_tag
...
@SC_354587 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354588 @fifth_scenario_tag
