@ST_123741 @tagtagtag @this_is_story_tag
...
@SC_525411 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525412 @third_scenario_tag
...
@SC_525413 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525414 @fifth_scenario_tag
