@ST_89523 @tagtagtag @this_is_story_tag
...
@SC_393426 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393427 @third_scenario_tag
...
@SC_393428 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393429 @fifth_scenario_tag
