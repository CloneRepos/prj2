@ST_106318 @tagtagtag @this_is_story_tag
...
@SC_457695 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457696 @third_scenario_tag
...
@SC_457697 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457698 @fifth_scenario_tag
