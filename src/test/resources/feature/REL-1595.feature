@ST_83913 @tagtagtag @this_is_story_tag
...
@SC_369803 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369804 @third_scenario_tag
...
@SC_369805 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369806 @fifth_scenario_tag
