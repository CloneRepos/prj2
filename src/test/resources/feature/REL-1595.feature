@ST_104422 @tagtagtag @this_is_story_tag
...
@SC_451077 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451078 @third_scenario_tag
...
@SC_451079 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451080 @fifth_scenario_tag
