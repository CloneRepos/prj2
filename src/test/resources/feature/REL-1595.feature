@ST_113851 @tagtagtag @this_is_story_tag
...
@SC_486538 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486539 @third_scenario_tag
...
@SC_486540 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486541 @fifth_scenario_tag
