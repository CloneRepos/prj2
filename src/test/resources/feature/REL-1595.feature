@ST_106745 @tagtagtag @this_is_story_tag
...
@SC_458955 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_458956 @third_scenario_tag
...
@SC_458957 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_458958 @fifth_scenario_tag
