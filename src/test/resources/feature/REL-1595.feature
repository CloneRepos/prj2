@ST_51551 @tagtagtag @this_is_story_tag
...
@SC_244642 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244643 @third_scenario_tag
...
@SC_244644 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244645 @fifth_scenario_tag
