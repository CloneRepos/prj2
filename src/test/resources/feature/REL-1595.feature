@ST_32669 @tagtagtag @this_is_story_tag
...
@SC_171184 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171185 @third_scenario_tag
...
@SC_171186 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171187 @fifth_scenario_tag
