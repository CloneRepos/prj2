@ST_58997 @tagtagtag @this_is_story_tag
...
@SC_273637 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273638 @third_scenario_tag
...
@SC_273639 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273640 @fifth_scenario_tag
