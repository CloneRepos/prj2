@ST_109871 @tagtagtag @this_is_story_tag
...
@SC_471249 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471250 @third_scenario_tag
...
@SC_471251 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471252 @fifth_scenario_tag
