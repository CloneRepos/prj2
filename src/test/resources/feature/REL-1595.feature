@ST_12855 @tagtagtag @this_is_story_tag
...
@SC_82487 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82488 @third_scenario_tag
...
@SC_82489 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82490 @fifth_scenario_tag
