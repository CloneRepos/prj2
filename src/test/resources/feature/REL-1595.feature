@ST_121143 @tagtagtag @this_is_story_tag
...
@SC_515222 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515223 @third_scenario_tag
...
@SC_515224 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515225 @fifth_scenario_tag
