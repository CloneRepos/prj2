@ST_63772 @tagtagtag @this_is_story_tag
...
@SC_290395 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290396 @third_scenario_tag
...
@SC_290397 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290398 @fifth_scenario_tag
