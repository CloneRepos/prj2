@ST_119059 @tagtagtag @this_is_story_tag
...
@SC_507026 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507027 @third_scenario_tag
...
@SC_507028 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507029 @fifth_scenario_tag
