@ST_14994 @tagtagtag @this_is_story_tag
...
@SC_97018 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97019 @third_scenario_tag
...
@SC_97020 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97021 @fifth_scenario_tag
