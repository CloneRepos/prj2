@ST_100262 @tagtagtag @this_is_story_tag
...
@SC_434753 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434754 @third_scenario_tag
...
@SC_434755 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434756 @fifth_scenario_tag
