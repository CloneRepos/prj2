@ST_108308 @tagtagtag @this_is_story_tag
...
@SC_465102 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465103 @third_scenario_tag
...
@SC_465104 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465105 @fifth_scenario_tag
