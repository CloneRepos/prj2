@ST_72524 @tagtagtag @this_is_story_tag
...
@SC_325956 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_325957 @third_scenario_tag
...
@SC_325958 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_325959 @fifth_scenario_tag
