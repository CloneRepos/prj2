@ST_74225 @tagtagtag @this_is_story_tag
...
@SC_332577 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332578 @third_scenario_tag
...
@SC_332579 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332580 @fifth_scenario_tag
