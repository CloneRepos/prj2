@ST_13341 @tagtagtag @this_is_story_tag
...
@SC_85000 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_85001 @third_scenario_tag
...
@SC_85002 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_85003 @fifth_scenario_tag
