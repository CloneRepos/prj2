@ST_116456 @tagtagtag @this_is_story_tag
...
@SC_496783 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496784 @third_scenario_tag
...
@SC_496785 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496786 @fifth_scenario_tag
