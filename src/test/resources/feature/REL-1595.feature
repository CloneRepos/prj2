@ST_95059 @tagtagtag @this_is_story_tag
...
@SC_414319 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_414320 @third_scenario_tag
...
@SC_414321 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_414322 @fifth_scenario_tag
