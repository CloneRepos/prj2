@ST_120622 @tagtagtag @this_is_story_tag
...
@SC_513173 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513174 @third_scenario_tag
...
@SC_513175 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513176 @fifth_scenario_tag
