@ST_45875 @tagtagtag @this_is_story_tag
...
@SC_222628 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222629 @third_scenario_tag
...
@SC_222630 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222631 @fifth_scenario_tag
