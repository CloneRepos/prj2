@ST_38325 @tagtagtag @this_is_story_tag
...
@SC_189734 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189735 @third_scenario_tag
...
@SC_189736 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189737 @fifth_scenario_tag
