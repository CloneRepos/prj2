@ST_114893 @tagtagtag @this_is_story_tag
...
@SC_490636 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490637 @third_scenario_tag
...
@SC_490638 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490639 @fifth_scenario_tag
