@ST_41818 @tagtagtag @this_is_story_tag
...
@SC_205387 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205388 @third_scenario_tag
...
@SC_205389 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205390 @fifth_scenario_tag
