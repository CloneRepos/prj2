@ST_57756 @tagtagtag @this_is_story_tag
...
@SC_268570 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268571 @third_scenario_tag
...
@SC_268572 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268573 @fifth_scenario_tag
