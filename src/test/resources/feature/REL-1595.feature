@ST_66304 @tagtagtag @this_is_story_tag
...
@SC_300951 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_300952 @third_scenario_tag
...
@SC_300953 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_300954 @fifth_scenario_tag
