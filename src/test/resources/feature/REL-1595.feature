@ST_91600 @tagtagtag @this_is_story_tag
...
@SC_401554 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401555 @third_scenario_tag
...
@SC_401556 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401557 @fifth_scenario_tag
