@ST_93684 @tagtagtag @this_is_story_tag
...
@SC_409750 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409751 @third_scenario_tag
...
@SC_409752 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409753 @fifth_scenario_tag
