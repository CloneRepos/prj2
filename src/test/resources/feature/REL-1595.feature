@ST_17140 @tagtagtag @this_is_story_tag
...
@SC_108331 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108332 @third_scenario_tag
...
@SC_108333 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108334 @fifth_scenario_tag
