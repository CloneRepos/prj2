@ST_122699 @tagtagtag @this_is_story_tag
...
@SC_521313 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521314 @third_scenario_tag
...
@SC_521315 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521316 @fifth_scenario_tag
