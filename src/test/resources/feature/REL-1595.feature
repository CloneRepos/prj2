@ST_30311 @tagtagtag @this_is_story_tag
...
@SC_160623 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160624 @third_scenario_tag
...
@SC_160625 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160626 @fifth_scenario_tag
