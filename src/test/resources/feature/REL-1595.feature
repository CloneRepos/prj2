@ST_93163 @tagtagtag @this_is_story_tag
...
@SC_407701 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407702 @third_scenario_tag
...
@SC_407703 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407704 @fifth_scenario_tag
