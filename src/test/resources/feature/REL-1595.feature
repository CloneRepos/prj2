@ST_82055 @tagtagtag @this_is_story_tag
...
@SC_362357 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362358 @third_scenario_tag
...
@SC_362359 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362360 @fifth_scenario_tag
