@ST_99741 @tagtagtag @this_is_story_tag
...
@SC_432704 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432705 @third_scenario_tag
...
@SC_432706 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432707 @fifth_scenario_tag
