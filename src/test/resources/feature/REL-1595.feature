@ST_69197 @tagtagtag @this_is_story_tag
...
@SC_312786 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312787 @third_scenario_tag
...
@SC_312788 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312789 @fifth_scenario_tag
