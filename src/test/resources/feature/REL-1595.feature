@ST_73667 @tagtagtag @this_is_story_tag
...
@SC_330160 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330161 @third_scenario_tag
...
@SC_330162 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330163 @fifth_scenario_tag
