@ST_111772 @tagtagtag @this_is_story_tag
...
@SC_478342 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478343 @third_scenario_tag
...
@SC_478344 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478345 @fifth_scenario_tag
