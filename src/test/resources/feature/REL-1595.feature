@ST_47175 @tagtagtag @this_is_story_tag
...
@SC_227316 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227317 @third_scenario_tag
...
@SC_227318 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227319 @fifth_scenario_tag
