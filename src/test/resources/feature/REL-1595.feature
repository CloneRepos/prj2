@ST_61610 @tagtagtag @this_is_story_tag
...
@SC_282732 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282733 @third_scenario_tag
...
@SC_282734 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282735 @fifth_scenario_tag
