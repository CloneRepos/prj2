@ST_125714 @tagtagtag @this_is_story_tag
...
@SC_532691 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532692 @third_scenario_tag
...
@SC_532693 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532694 @fifth_scenario_tag
