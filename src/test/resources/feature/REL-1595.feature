@ST_62498 @tagtagtag @this_is_story_tag
...
@SC_286310 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286311 @third_scenario_tag
...
@SC_286312 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286313 @fifth_scenario_tag
