@ST_87848 @tagtagtag @this_is_story_tag
...
@SC_386278 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386279 @third_scenario_tag
...
@SC_386280 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386281 @fifth_scenario_tag
