@ST_108829 @tagtagtag @this_is_story_tag
...
@SC_467151 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467152 @third_scenario_tag
...
@SC_467153 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467154 @fifth_scenario_tag
