@ST_47602 @tagtagtag @this_is_story_tag
...
@SC_228575 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228576 @third_scenario_tag
...
@SC_228577 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228578 @fifth_scenario_tag
