@ST_95580 @tagtagtag @this_is_story_tag
...
@SC_416368 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416369 @third_scenario_tag
...
@SC_416370 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416371 @fifth_scenario_tag
