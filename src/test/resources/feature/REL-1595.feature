@ST_49253 @tagtagtag @this_is_story_tag
...
@SC_234674 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234675 @third_scenario_tag
...
@SC_234676 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234677 @fifth_scenario_tag
