@ST_36482 @tagtagtag @this_is_story_tag
...
@SC_183441 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183442 @third_scenario_tag
...
@SC_183443 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183444 @fifth_scenario_tag
