@ST_111340 @tagtagtag @this_is_story_tag
...
@SC_476607 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476608 @third_scenario_tag
...
@SC_476609 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476610 @fifth_scenario_tag
