@ST_92121 @tagtagtag @this_is_story_tag
...
@SC_403603 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403604 @third_scenario_tag
...
@SC_403605 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403606 @fifth_scenario_tag
