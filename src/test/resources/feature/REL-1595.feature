@ST_94632 @tagtagtag @this_is_story_tag
...
@SC_413059 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413060 @third_scenario_tag
...
@SC_413061 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413062 @fifth_scenario_tag
