@ST_80985 @tagtagtag @this_is_story_tag
...
@SC_357992 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_357993 @third_scenario_tag
...
@SC_357994 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_357995 @fifth_scenario_tag
