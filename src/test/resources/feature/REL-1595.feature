@ST_115414 @tagtagtag @this_is_story_tag
...
@SC_492685 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492686 @third_scenario_tag
...
@SC_492687 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492688 @fifth_scenario_tag
