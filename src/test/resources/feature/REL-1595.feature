@ST_99220 @tagtagtag @this_is_story_tag
...
@SC_430655 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430656 @third_scenario_tag
...
@SC_430657 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430658 @fifth_scenario_tag
