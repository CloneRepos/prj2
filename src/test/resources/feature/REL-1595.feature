@ST_98178 @tagtagtag @this_is_story_tag
...
@SC_426557 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426558 @third_scenario_tag
...
@SC_426559 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426560 @fifth_scenario_tag
