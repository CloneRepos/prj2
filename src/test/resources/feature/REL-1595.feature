@ST_114372 @tagtagtag @this_is_story_tag
...
@SC_488587 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488588 @third_scenario_tag
...
@SC_488589 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488590 @fifth_scenario_tag
