@ST_58454 @tagtagtag @this_is_story_tag
...
@SC_271357 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_271358 @third_scenario_tag
...
@SC_271359 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_271360 @fifth_scenario_tag
