@ST_113330 @tagtagtag @this_is_story_tag
...
@SC_484489 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484490 @third_scenario_tag
...
@SC_484491 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484492 @fifth_scenario_tag
