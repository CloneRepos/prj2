@ST_85587 @tagtagtag @this_is_story_tag
...
@SC_376981 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_376982 @third_scenario_tag
...
@SC_376983 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_376984 @fifth_scenario_tag
