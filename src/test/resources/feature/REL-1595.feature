@ST_102338 @tagtagtag @this_is_story_tag
...
@SC_442881 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_442882 @third_scenario_tag
...
@SC_442883 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_442884 @fifth_scenario_tag
