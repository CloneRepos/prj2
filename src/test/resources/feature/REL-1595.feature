@ST_118018 @tagtagtag @this_is_story_tag
...
@SC_502929 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502930 @third_scenario_tag
...
@SC_502931 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502932 @fifth_scenario_tag
