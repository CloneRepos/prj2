@ST_117497 @tagtagtag @this_is_story_tag
...
@SC_500880 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_500881 @third_scenario_tag
...
@SC_500882 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_500883 @fifth_scenario_tag
