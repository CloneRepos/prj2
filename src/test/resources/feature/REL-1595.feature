@ST_107787 @tagtagtag @this_is_story_tag
...
@SC_463053 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_463054 @third_scenario_tag
...
@SC_463055 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_463056 @fifth_scenario_tag
