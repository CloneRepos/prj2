@ST_78917 @tagtagtag @this_is_story_tag
...
@SC_350549 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350550 @third_scenario_tag
...
@SC_350551 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350552 @fifth_scenario_tag
