@ST_84544 @tagtagtag @this_is_story_tag
...
@SC_372882 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372883 @third_scenario_tag
...
@SC_372884 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372885 @fifth_scenario_tag
