@ST_76155 @tagtagtag @this_is_story_tag
...
@SC_340333 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340334 @third_scenario_tag
...
@SC_340335 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340336 @fifth_scenario_tag
