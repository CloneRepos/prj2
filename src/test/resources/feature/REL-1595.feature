@ST_34414 @tagtagtag @this_is_story_tag
...
@SC_177205 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177206 @third_scenario_tag
...
@SC_177207 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177208 @fifth_scenario_tag
