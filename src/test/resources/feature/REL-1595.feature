@ST_110298 @tagtagtag @this_is_story_tag
...
@SC_472509 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472510 @third_scenario_tag
...
@SC_472511 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472512 @fifth_scenario_tag
