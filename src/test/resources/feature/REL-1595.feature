@ST_46580 @tagtagtag @this_is_story_tag
...
@SC_225426 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225427 @third_scenario_tag
...
@SC_225428 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225429 @fifth_scenario_tag
