@ST_83385 @tagtagtag @this_is_story_tag
...
@SC_367698 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367699 @third_scenario_tag
...
@SC_367700 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367701 @fifth_scenario_tag
