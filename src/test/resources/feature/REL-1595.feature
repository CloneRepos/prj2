@ST_109350 @tagtagtag @this_is_story_tag
...
@SC_469200 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469201 @third_scenario_tag
...
@SC_469202 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469203 @fifth_scenario_tag
