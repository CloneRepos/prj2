@ST_120101 @tagtagtag @this_is_story_tag
...
@SC_511124 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511125 @third_scenario_tag
...
@SC_511126 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511127 @fifth_scenario_tag
