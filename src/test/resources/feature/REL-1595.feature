@ST_62040 @tagtagtag @this_is_story_tag
...
@SC_284130 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284131 @third_scenario_tag
...
@SC_284132 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284133 @fifth_scenario_tag
