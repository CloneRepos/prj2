@ST_28651 @tagtagtag @this_is_story_tag
...
@SC_151926 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_151927 @third_scenario_tag
...
@SC_151928 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_151929 @fifth_scenario_tag
