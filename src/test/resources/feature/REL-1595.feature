@ST_56429 @tagtagtag @this_is_story_tag
...
@SC_264156 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264157 @third_scenario_tag
...
@SC_264158 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264159 @fifth_scenario_tag
