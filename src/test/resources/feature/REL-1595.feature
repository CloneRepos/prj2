@ST_89002 @tagtagtag @this_is_story_tag
...
@SC_391377 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391378 @third_scenario_tag
...
@SC_391379 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391380 @fifth_scenario_tag
