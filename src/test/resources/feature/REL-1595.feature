@ST_78224 @tagtagtag @this_is_story_tag
...
@SC_347728 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347729 @third_scenario_tag
...
@SC_347730 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347731 @fifth_scenario_tag
