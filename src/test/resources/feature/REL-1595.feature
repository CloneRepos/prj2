@ST_12515 @tagtagtag @this_is_story_tag
...
@SC_81539 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81540 @third_scenario_tag
...
@SC_81541 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81542 @fifth_scenario_tag
