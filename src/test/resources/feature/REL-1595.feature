@ST_64795 @tagtagtag @this_is_story_tag
...
@SC_293599 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293600 @third_scenario_tag
...
@SC_293601 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293602 @fifth_scenario_tag
