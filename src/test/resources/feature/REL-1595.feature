@ST_56833 @tagtagtag @this_is_story_tag
...
@SC_265300 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265301 @third_scenario_tag
...
@SC_265302 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265303 @fifth_scenario_tag
