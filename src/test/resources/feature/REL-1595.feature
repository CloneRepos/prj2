@ST_52934 @tagtagtag @this_is_story_tag
...
@SC_251084 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251085 @third_scenario_tag
...
@SC_251086 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251087 @fifth_scenario_tag
