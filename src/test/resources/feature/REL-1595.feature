@ST_94111 @tagtagtag @this_is_story_tag
...
@SC_411010 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411011 @third_scenario_tag
...
@SC_411012 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411013 @fifth_scenario_tag
