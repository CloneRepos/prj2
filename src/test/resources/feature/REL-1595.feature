@ST_96094 @tagtagtag @this_is_story_tag
...
@SC_418361 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418362 @third_scenario_tag
...
@SC_418363 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418364 @fifth_scenario_tag
