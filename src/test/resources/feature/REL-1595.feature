@ST_112809 @tagtagtag @this_is_story_tag
...
@SC_482440 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482441 @third_scenario_tag
...
@SC_482442 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482443 @fifth_scenario_tag
