@ST_50376 @tagtagtag @this_is_story_tag
...
@SC_238667 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238668 @third_scenario_tag
...
@SC_238669 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238670 @fifth_scenario_tag
