@ST_71568 @tagtagtag @this_is_story_tag
...
@SC_322586 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322587 @third_scenario_tag
...
@SC_322588 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322589 @fifth_scenario_tag
