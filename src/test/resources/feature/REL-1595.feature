@ST_44716 @tagtagtag @this_is_story_tag
...
@SC_217486 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217487 @third_scenario_tag
...
@SC_217488 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217489 @fifth_scenario_tag
