@ST_90558 @tagtagtag @this_is_story_tag
...
@SC_397456 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397457 @third_scenario_tag
...
@SC_397458 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397459 @fifth_scenario_tag
