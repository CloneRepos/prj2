@ST_43555 @tagtagtag @this_is_story_tag
...
@SC_212363 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212364 @third_scenario_tag
...
@SC_212365 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212366 @fifth_scenario_tag
