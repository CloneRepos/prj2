@ST_69095 @tagtagtag @this_is_story_tag
...
@SC_312594 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312595 @third_scenario_tag
...
@SC_312596 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312597 @fifth_scenario_tag
