@ST_124262 @tagtagtag @this_is_story_tag
...
@SC_527460 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527461 @third_scenario_tag
...
@SC_527462 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527463 @fifth_scenario_tag
