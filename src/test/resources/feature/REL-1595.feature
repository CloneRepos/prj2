@ST_73239 @tagtagtag @this_is_story_tag
...
@SC_328900 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_328901 @third_scenario_tag
...
@SC_328902 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_328903 @fifth_scenario_tag
