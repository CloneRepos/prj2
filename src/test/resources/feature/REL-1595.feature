@ST_77280 @tagtagtag @this_is_story_tag
...
@SC_344379 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344380 @third_scenario_tag
...
@SC_344381 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344382 @fifth_scenario_tag
