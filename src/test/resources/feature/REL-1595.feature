@ST_39681 @tagtagtag @this_is_story_tag
...
@SC_196822 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196823 @third_scenario_tag
...
@SC_196824 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196825 @fifth_scenario_tag
