@ST_61020 @tagtagtag @this_is_story_tag
...
@SC_280846 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280847 @third_scenario_tag
...
@SC_280848 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280849 @fifth_scenario_tag
