@ST_11738 @tagtagtag @this_is_story_tag
...
@SC_78178 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78179 @third_scenario_tag
...
@SC_78180 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78181 @fifth_scenario_tag
