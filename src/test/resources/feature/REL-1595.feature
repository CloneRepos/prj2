@ST_61290 @tagtagtag @this_is_story_tag
...
@SC_282420 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282421 @third_scenario_tag
...
@SC_282422 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282423 @fifth_scenario_tag
