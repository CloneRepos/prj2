@ST_35201 @tagtagtag @this_is_story_tag
...
@SC_179655 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179656 @third_scenario_tag
...
@SC_179657 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179658 @fifth_scenario_tag
