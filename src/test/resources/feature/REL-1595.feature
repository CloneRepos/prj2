@ST_97657 @tagtagtag @this_is_story_tag
...
@SC_424508 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424509 @third_scenario_tag
...
@SC_424510 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424511 @fifth_scenario_tag
