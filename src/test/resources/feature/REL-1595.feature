@ST_85066 @tagtagtag @this_is_story_tag
...
@SC_374932 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_374933 @third_scenario_tag
...
@SC_374934 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_374935 @fifth_scenario_tag
