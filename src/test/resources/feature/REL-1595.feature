@ST_40128 @tagtagtag @this_is_story_tag
...
@SC_198291 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198292 @third_scenario_tag
...
@SC_198293 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198294 @fifth_scenario_tag
