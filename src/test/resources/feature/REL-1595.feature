@ST_49697 @tagtagtag @this_is_story_tag
...
@SC_236467 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236468 @third_scenario_tag
...
@SC_236469 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236470 @fifth_scenario_tag
