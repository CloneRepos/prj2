@ST_122178 @tagtagtag @this_is_story_tag
...
@SC_519264 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519265 @third_scenario_tag
...
@SC_519266 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519267 @fifth_scenario_tag
