@ST_115935 @tagtagtag @this_is_story_tag
...
@SC_494734 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_494735 @third_scenario_tag
...
@SC_494736 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_494737 @fifth_scenario_tag
