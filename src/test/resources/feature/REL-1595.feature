@ST_76582 @tagtagtag @this_is_story_tag
...
@SC_341593 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341594 @third_scenario_tag
...
@SC_341595 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341596 @fifth_scenario_tag
