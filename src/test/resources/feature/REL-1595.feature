@ST_8868 @tagtagtag @this_is_story_tag
...
@SC_61268 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61269 @third_scenario_tag
...
@SC_61270 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61271 @fifth_scenario_tag
