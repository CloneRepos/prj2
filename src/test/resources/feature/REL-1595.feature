@ST_11084 @tagtagtag @this_is_story_tag
...
@SC_73070 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73071 @third_scenario_tag
...
@SC_73072 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73073 @fifth_scenario_tag
