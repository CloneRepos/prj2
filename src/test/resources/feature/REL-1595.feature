@ST_96615 @tagtagtag @this_is_story_tag
...
@SC_420410 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420411 @third_scenario_tag
...
@SC_420412 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420413 @fifth_scenario_tag
