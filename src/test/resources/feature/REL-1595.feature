@ST_42335 @tagtagtag @this_is_story_tag
...
@SC_207400 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207401 @third_scenario_tag
...
@SC_207402 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207403 @fifth_scenario_tag
