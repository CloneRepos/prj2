@ST_48123 @tagtagtag @this_is_story_tag
...
@SC_230625 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230626 @third_scenario_tag
...
@SC_230627 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230628 @fifth_scenario_tag
