@ST_34857 @tagtagtag @this_is_story_tag
...
@SC_178654 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178655 @third_scenario_tag
...
@SC_178656 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178657 @fifth_scenario_tag
