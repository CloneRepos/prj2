@ST_121657 @tagtagtag @this_is_story_tag
...
@SC_517215 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517216 @third_scenario_tag
...
@SC_517217 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517218 @fifth_scenario_tag
