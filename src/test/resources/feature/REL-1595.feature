@ST_124689 @tagtagtag @this_is_story_tag
...
@SC_528720 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528721 @third_scenario_tag
...
@SC_528722 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528723 @fifth_scenario_tag
