@ST_45301 @tagtagtag @this_is_story_tag
...
@SC_220083 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220084 @third_scenario_tag
...
@SC_220085 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220086 @fifth_scenario_tag
