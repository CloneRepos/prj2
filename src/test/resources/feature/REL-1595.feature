@ST_74943 @tagtagtag @this_is_story_tag
...
@SC_335561 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335562 @third_scenario_tag
...
@SC_335563 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335564 @fifth_scenario_tag
