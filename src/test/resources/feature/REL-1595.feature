@ST_75433 @tagtagtag @this_is_story_tag
...
@SC_337325 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337326 @third_scenario_tag
...
@SC_337327 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337328 @fifth_scenario_tag
