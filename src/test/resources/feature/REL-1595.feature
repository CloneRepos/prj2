@ST_44105 @tagtagtag @this_is_story_tag
...
@SC_214540 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214541 @third_scenario_tag
...
@SC_214542 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214543 @fifth_scenario_tag
