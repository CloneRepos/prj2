@ST_123220 @tagtagtag @this_is_story_tag
...
@SC_523362 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523363 @third_scenario_tag
...
@SC_523364 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523365 @fifth_scenario_tag
