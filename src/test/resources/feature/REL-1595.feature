@ST_98699 @tagtagtag @this_is_story_tag
...
@SC_428606 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428607 @third_scenario_tag
...
@SC_428608 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428609 @fifth_scenario_tag
