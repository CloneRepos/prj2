@ST_32115 @tagtagtag @this_is_story_tag
...
@SC_168782 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168783 @third_scenario_tag
...
@SC_168784 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168785 @fifth_scenario_tag
