@ST_82583 @tagtagtag @this_is_story_tag
...
@SC_364462 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364463 @third_scenario_tag
...
@SC_364464 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364465 @fifth_scenario_tag
